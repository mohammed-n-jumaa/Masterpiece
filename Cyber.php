...
<head>
    ...
    <meta content="Law Firm Website Template" name="description">    <title>Cyber Law Consultations</title>
     <!-- Favicon -->
...
<div class="container mt-5">
    ...
    <div class="section-header text-center mb-4">
        <h2>Cyber Law Consultations</h2>
        <p class="lead">Submit your questions related to Cyber Law and receive professional legal responses from our lawyers.</p>
    </div>
