...
<div class="container profile-container">
    ...
    <div class="profile-header">
        <img src="img/prof.jpg" alt="Lawyer's photo">
        <div class="profile-info">
            <h2>Lawyer Name</h2>
            <p>Specialization: Criminal Law</p>
            <p>Experience: 15 Years</p>
            <p>Email: mohammed.alqadome@gmail.com</p>
            <p>Phone: 0787665773</p>
        </div>
    </div>
    ...
    <div class="reviews-section">
        ...
        <div class="owl-carousel owl-theme">
            <div class="review">
                <img src="img/testimonial-1.jpg" alt="Ahmed Ali" class="img-fluid rounded-circle mb-2" style="width: 60px;">
                <strong>أحمد علي</strong>
                <p>كانت الاستشارة مفيدة وسريعة، أشكر عطوفة المحامي على اهتمامه بجميع استفساراتي.</p>
            </div>
            <div class="review">
                <img src="img/testimonial-2.jpg" alt="Sara Mohammed" class="img-fluid rounded-circle mb-2" style="width: 60px;">
                <strong>سارة محمد</strong>
                <p>الخدمة رائعة وقد حصلت على استشارة دقيقة لقضيتي. أوصي الجميع باستخدام هذه المنصة.</p>
            </div>
            <div class="review">
                <img src="img/testimonial-3.jpg" alt="Khalid Abdullah" class="img-fluid rounded-circle mb-2" style="width: 60px;">
                <strong>خالد عبدالله</strong>
                <p>الموقع سهل الاستخدام وفريق المحامين متعاون جداً، حصلت على نصيحة قيمة في وقت قصير.</p>
            </div>
            <div class="review">
                <img src="img/testimonial-1.jpg" alt="Ahmed Ali" class="img-fluid rounded-circle mb-2" style="width: 60px;">
                <strong>أحمد علي</strong>
