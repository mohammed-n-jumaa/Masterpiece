...
<head>
    ...
    <meta content="Law Firm Website Template" name="description">    <title>State Law Consultations</title>
     <!-- Favicon -->
...
<div class="container mt-5">
    ...
    <div class="section-header text-center mb-4">
        <h2>State Law Consultations</h2>
        <p class="lead">Submit your questions related to State Security Cases and receive professional legal responses from our lawyers.</p>
    </div>
