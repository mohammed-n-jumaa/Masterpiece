...
<link href="lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">    <style>
      body {
...
.container {
    max-width: 600px; /* تقليل العرض الكلي للفورم */
...
.form-header span.active {
    background-color: #a18f66; /* اللون الغامق عند تفعيل الزر */
    color: #fff;
}

.form-header span:hover:not(.active) {
    background-color: #a6882a; /* لون أغمق عند التمرير */
    color: #fff;
}

.form-group label {
    color: #d4af37;
    font-size: 14px; /* تقليل حجم الخط للوسوم */
}
...
.form-control {
    ...
    border: none;
    color: #fff;
    margin-bottom: 12px; /* تقليل التباعد بين الحقول */
